...
public:
    AiMCCDAQ(const std::string deviceID, const unsigned int numChannels, const std::vector<std::pair<std::array<double, 5>, std::array<double, 5>>> calibrationPoints, DaqDeviceHandle handle, Range voltageRange);
    ~AiMCCDAQ();
